...
const styles = {
  ...
  backButton: {
    padding: "8px 16px",
    backgroundColor: "#e6e1da", // warm muted beige
  ...
  description: {
    marginBottom: "20px",
    color: "#665c54", // soft warm gray-brown
  },
  error: {
    color: "#a94442", // warm bootstrap red
    marginBottom: "15px",
  },
  tabs: {
    display: "flex",
    borderBottom: "1px solid #d6cfc7", // soft taupe
    marginBottom: "20px",
  },
  tab: {
    padding: "10px 20px",
  ...
  activeTab: {
    padding: "10px 20px",
    backgroundColor: "transparent",
    borderBottom: "2px solid #b46e53", // terracotta underline
    fontWeight: "bold",
    cursor: "pointer",
    color: "#4a3a30",
  },
  ...
  memberCard: {
    backgroundColor: "#f5f1ea", // light beige
    borderRadius: "4px",
    padding: "15px",
    position: "relative",
  },
  ...
  ownerBadge: {
    ...
    top: "10px",
    right: "10px",
    backgroundColor: "#b46e53", // warm highlight
    color: "#fff",
    padding: "3px 6px",
    borderRadius: "4px",
    fontSize: "12px",
