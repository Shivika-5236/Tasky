...
const styles = {
  header: {
    ...
    alignItems: "center",
    marginBottom: "24px", // Slightly increased spacing
  },
  createButton: {
    padding: "10px 18px", // More comfortable padding
    backgroundColor: "#b36b00",
    color: "#fff",
    textDecoration: "none",
    borderRadius: "6px", // Slightly rounded for softer design
  ...
  error: {
    color: "red",
    marginBottom: "18px", // Enhanced spacing
  },
  noProjects: {
    textAlign: "center",
    padding: "48px",
